...
const InventApp = ({ data }) => {
    ...
    const onRowsPerPageChange = useCallback((e) => {
        ...
        if (value === "all") {
            setRowsPerPage(filteredItems.length); // Menetapkan jumlah baris per halaman menjadi total jumlah item
        } else {
    ...
    return (
        <Table
            ...
            classNames={{ wrapper: "max-h-[500px] overflow-auto" }} // Tambahkan overflow-auto untuk menangani overflow
